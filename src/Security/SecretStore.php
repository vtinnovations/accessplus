 ...
 *   - Ciphertext lives in var/accessplus/secrets.json (hex strings, never plain).
 *   - The encryption key lives in a SEPARATE file var/accessplus/secret.key with
...
{
    private const KEY_RELATIVE_PATH = 'var/accessplus/secret.key';

    private const STORE_RELATIVE_PATH = 'var/accessplus/secrets.json';
    ...
    /**
     * Loads the encryption key from var/accessplus/secret.key, generating it on
