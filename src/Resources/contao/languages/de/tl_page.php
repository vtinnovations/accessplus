...
$GLOBALS['TL_LANG']['tl_page']['accessibility_legend'] = 'Barrierefreiheit';

$GLOBALS['TL_LANG']['tl_page']['accessibility_licence'] = array('Zugänglichkeit Lizenz', 'Bitte Zugänglichkeitslizenz eingeben');
